...
<?php
                ...
                $result = $conn->query("SELECT * FROM customer WHERE email='$cust_id'") or die(mysql_error());
        ...
        <div class='content_customer'>
           ...
           <?php include 'customer_navbar.php'?>
            ...
            <?php
                ...
                $result = $conn->query("SELECT * FROM passbook".$_SESSION['login_id']) ;
                ;
...
?>
            ...
            <div class="content2">
            <p><span class="heading">Balance: BDTK </span><?php echo $balance;?></p>
