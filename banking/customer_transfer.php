...
.head{
  ...
  text-align:center;
    ...
    font-weight:bold;
        ...
        $result = $conn->query("SELECT * FROM beneficiary1 WHERE sender_id='$sender_id' AND status='ACTIVE'") or die(mysql_error());
        ...
        $result= $conn->query("SELECT * FROM beneficiary1 WHERE sender_id='$sender_id' AND status='ACTIVE'");
